---
title: 第 4 章 模块应该是深的 | 《软件设计的哲学》中文版
...
![](https://cactus-proj.github.io/A-Philosophy-of-Software-Design-zh/assets/00012.CcqL0Jgd.jpeg)
...
```c
cint open(const char* path, int flags, mode_t permissions);
...
```java
javaprivate void addNullValueForAttribute(String attribute) {
...
```java
javaFileInputStream fileStream = new FileInputStream(fileName);
