...
| 原始文档 (Clippings/) | 摘要文档 (Wiki/Summaries/) | 状态 |
| -------------------- | ------------------------ | ---- |
| 第七章 事务.md | S-第七章-分布式事务.md | OK |
| 第 2 章 复杂性的本质  《软件设计的哲学》中文版.md | S-第2章：复杂性的本质.md | OK |
| 第 3 章 工作代码是不够的  《软件设计的哲学》中文版.md | S-第3章-工作代码是不够的.md | OK |
| 第 4 章 模块应该是深的  《软件设计的哲学》中文版.md | S-第4章-模块应该是深的.md | OK |
| 第 5 章 信息隐藏(和泄漏)  《软件设计的哲学》中文版.md | S-第5章-信息隐藏.md | OK |
...
| 深度复盘-重启 etcd 引发的异常.md | S-深度复盘-etcd异常.md | OK |
| Anthropic 官方博文：多智能体协作指南：五种主流模式怎么选、怎么用？【译】.md | S-多智能体协作指南.md | OK |
| 最硬核的一次 Linux 内核重构.md | S-最硬核的一次Linux内核重构.md | OK |
| Rockraft：基于 OpenRaft 与 RocksDB 的强一致 KV 存储框架.md | S-Rockraft.md | OK |
| 工程技术：在智能体优先的世界中利用 Codex.md | S-利用Codex构建.md | OK |
| GreptimeDB 开源四年：回望出发、决策、弯路，和同行的人.md | S-GreptimeDB开源四年.md | OK |
| TLS完全指南.md | S-TLS完全指南.md | OK |
| LLM Knowledge Bases by @karpathy.md | S-LLM Knowledge Bases by karpathy.md | OK |
| Obsidian 的 PC 端同步方案，无代码搞定 Git 同步.md | S-Obsidian的PC端Git同步方案.md | OK |
...
| DDIA-5-冗余.md | S-DDIA-第5章-分布式数据复制.md | OK |
...
| Chapter 4 Learning From Sequences and Alignments  From sequences to knowledge, improving and learning from sequence alignments.md | S-Chapter4-LearningFromSequences.md | OK |
...
| Learning Beyond Gradients.md | S-LearningBeyondGradients.md | OK |

---

## Concepts Summary

共 35 个概念文档，关联来源数详见 [[Wiki/Concepts/INDEX.md]]。
