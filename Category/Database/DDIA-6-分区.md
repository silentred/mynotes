...
![partition and replication](https://ddia.qtmuniao.com/img/ch06-fig01.png)
...
![encyclopedia example](https://ddia.qtmuniao.com/img/ch06-fig02.png)
...
![partition by hash key](https://ddia.qtmuniao.com/img/ch06-fig03.png)
...
![dynamo partitioning and replication](https://ddia.qtmuniao.com/img/ch06-dynamo.png)
...
一种折中方式，和上小节一样，使用组合的方式，先散列，再顺序。如使用主键进行散列得到分区，在每个分区内使用其他列顺序存储。如在社交网络上，首先按 user\_id 进行散列分区，再使用 update\_time 对用户事件进行顺序排序，则可以通过 (user\_id, update\_timestamp) 高效查询某个用户一段事件的事件。
...
![secondary by doc](https://ddia.qtmuniao.com/img/ch06-fig04.png)
...
![secondary by term](https://ddia.qtmuniao.com/img/ch06-fig05.png)
...
![add new node and rebalancing](https://ddia.qtmuniao.com/img/ch06-fig06.png)
...
![routing request ways](https://ddia.qtmuniao.com/img/ch06-fig07.png)
...
![zookeeper partitions](https://ddia.qtmuniao.com/img/ch06-fig08.png)
